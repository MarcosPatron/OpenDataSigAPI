...
namespace OpenDataSigAPI.Services.OpenAi
{
    public interface IOpenAiService
    {
        ...
        Task<Shared.Models.OpenAi.Assistant.Response.Thread> CreateThreadAsync(CreateThread request);
        ...
        Task<Shared.Models.OpenAi.Assistant.Response.Thread> RetrieveTheadAsync(string threadId);
        Task<Run> SubmitToolOutputsAsync(Shared.Models.OpenAi.Assistant.Request.SubmitToolOutputs request, string threadId, string runId);

        //CHAT
        Task<ChatCompletionResponse> ChatCompletion(ChatCompletionRequest request);

        //FILES
        Task<Shared.Models.OpenAi.Files.Response.File> UploadFile(UploadFile request);
